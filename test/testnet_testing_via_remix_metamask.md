# Testing contract using Remix and MetaMask

This section covers testing at the contract level, using Remix and MetaMask (as apposed to testing via the User Interface (UI)).
